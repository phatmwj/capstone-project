...
-keepclassmembers class * extends winwin.customer.app.data.model.api.request.BaseRequest { *;}
-keep class com.pos.android.data.model.api.response.BaseResponse**
-keepclassmembers class * extends winwin.customer.app.data.model.api.response.BaseResponse { *;}